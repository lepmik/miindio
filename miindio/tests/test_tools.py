...
from miindio.tools import set_params, convert_xml_dict, dict_changed

def test_dictify():
    from miindio.tools import dictify
    a = {
        'a': {'b': 'c'},
        'd': ['e', 'f', [1, 2, 'd']],
        'g': 1,
...
def test_listify():
    from miindio.tools import listify
    a = {
        'a': {'b': 'c'},
...
def test_read_write_dict_equal():
    from miindio.tools import dump_xml, to_json
